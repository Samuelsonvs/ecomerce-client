    ...
    return (
        <li key={productLast._id} className="w-80 min-h-96 ml-7 mr-7 mt-20 rounded-2xl p-5">
            <div className="">
                ...
                <Link className="container flex justify-center mt-5 cursor-pointer transform hover:scale-110 transition duration-700 ease-in-out motion-reduce:transform-none"> 
                    <img className="shadow-xl rounded-xl" src={productLast.image} alt={productLast.description} />
                </Link>
            ...
            <h6 className="py-3 px-4 bg-indigo-500 text-white text-center cursor-pointer font-semibold rounded-lg shadow-md hover:bg-indigo-900">
            <Link>{productLast.category}</Link>
            </h6>
       </li>
    )
}
