    ...
    return (
        <li key={state._id} className="w-80 min-h-96 ml-7 mr-7 mt-20 rounded-2xl p-5">
            <div className="">
                ...
                <Link to={`/ilan/${state._id}`} className="container flex justify-center mt-5 cursor-pointer transform hover:scale-110 transition duration-700 ease-in-out motion-reduce:transform-none"> 
                    <img className="h-64 w-full object-cover shadow-xl rounded-xl" src={state.image[0]} alt={"card-icon"} />
                </Link>
                <p className="leading-10 mb-10 text-gray-500">
